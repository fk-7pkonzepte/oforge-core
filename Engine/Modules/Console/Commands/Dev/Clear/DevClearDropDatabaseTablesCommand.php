 ...
 */
class DevClearDropDatabaseTablesCommand extends AbstractCommand {

    /**
     * DevClearDatabaseCommand constructor.
     */
    public function __construct() {
        parent::__construct('oforge:dev:clear:db:drop', self::TYPE_DEVELOPMENT);
        $this->setDescription('Drop database tables');
    }
